...
public class Constants {
    public static FollowerConstants followerConstants = new FollowerConstants()
            .mass(12)
            .forwardZeroPowerAcceleration(-28.95)
            .lateralZeroPowerAcceleration(-52.5)
            //.useSecondaryTranslationalPIDF(true)
            //.useSecondaryHeadingPIDF(true)
            //.useSecondaryDrivePIDF(true)
            .translationalPIDFCoefficients(new PIDFCoefficients(0.041, 0, 0, 0.03))
            //.secondaryTranslationalPIDFCoefficients(new PIDFCoefficients(0.09, 0, 0.005, 0))
            .headingPIDFCoefficients(new PIDFCoefficients(1, 0, 0.15, 0.04))
            //.secondaryHeadingPIDFCoefficients(new PIDFCoefficients(0.5, 0, 0.05, 0))
            .drivePIDFCoefficients(new FilteredPIDFCoefficients(0.017, 0, 0.0013, 0, 0.01))
